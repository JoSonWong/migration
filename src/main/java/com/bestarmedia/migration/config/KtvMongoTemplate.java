...
@Configuration
@EnableMongoRepositories(basePackages = "com.bestarmedia.migration.repository.mongo.ktv", mongoTemplateRef = "ktvMongoTemplate")
public class KtvMongoTemplate {

    @Autowired
    private ApplicationContext appContext;

    @Autowired
    @Qualifier("ktvMongoProperties")
    private MongoProperties ktvMongoProperties;

    @Primary
    @Bean(name = "ktvMongo")
    public MongoTemplate ktvMongoTemplate() throws Exception {
        MongoDbFactory factory = ktvFactory(this.ktvMongoProperties);
    ...
    @Bean
    @Primary
    public MongoDbFactory ktvFactory(MongoProperties mongoProperties) throws Exception {
