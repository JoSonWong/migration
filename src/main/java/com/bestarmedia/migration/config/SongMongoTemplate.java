...
@Configuration
@EnableMongoRepositories(basePackages = "com.bestarmedia.migration.repository.mongo.song", mongoTemplateRef = "songMongo")
public class SongMongoTemplate {

    @Autowired
    private ApplicationContext appContext;

    @Autowired
    @Qualifier("songMongoProperties")
    private MongoProperties songMongoProperties;

    @Bean(name = "songMongo")
    public MongoTemplate songTemplate() throws Exception {
        MongoDbFactory factory = songFactory(this.songMongoProperties);
    ...
    @Bean
    public MongoDbFactory songFactory(MongoProperties mongoProperties) throws Exception {
